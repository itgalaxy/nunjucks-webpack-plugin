...
test(
    'should execute successfully when option `template` is object',
    (t) => {
...
test(
    'should execute successfully when option `template` is array',
    (t) => {
        const tmpDirectory = tempy.directory();
        const templateName = 'test.njk';
...
test(
    'should execute successfully when option `template` and `context` are passed',
    (t) => {
        const tmpDirectory = tempy.directory();
...
test(
    'should execute successfully when option `template` is object and `template.to` is absolute',
    (t) => {
        const tmpDirectory = tempy.directory();
        const templateName = 'test.njk';
        const webpackConfig = Object.assign({}, webpackConfigBase, {
